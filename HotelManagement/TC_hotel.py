...
class TestHotel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_room = HotelRoom(room_number=101, room_type="single", price=100.00, is_available=True)
    ...
    def test_reserve_room(self):
        ...
        self.assertTrue(result, "HotelRoom reservation should succeed")
        ...
        self.assertFalse(reserved_room.is_available, "HotelRoom should be marked as not available after reservation")
    ...
    def test_cancel_reservation(self):
        ...
        room_number = 101
        hotel.rooms.append(HotelRoom(room_number, "double", 150))
